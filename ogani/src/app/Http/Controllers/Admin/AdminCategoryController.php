...
class AdminCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // return
            return redirect()->route('admin.category.index')->with('success', 'Added category successfully');
        } catch (\Throwable $e) {
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            // return
            return redirect()->route('admin.category.index')->with('success', 'Updated category successfully');
        } catch (\Throwable $e) {
            Storage::delete($imagePath);
            return redirect()->back()->withInput()->withErrors(['error' => 'Error']);
        }
