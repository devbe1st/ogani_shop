                        ...
                        <div class="sidebar__item">
                            ...
                            <ul>
                                @foreach ($categories as $category)
                                    <li><a href="#">{{ $category->category_name }} ({{ $category->quantityProduct($category->id) }})</a></li> 
                                @endforeach
                            </ul>
                        </div>
                        <div class="sidebar__item">
                                            ...
                                            @foreach ($chunk as $sellingProduct)
                                                <a href="{{ route('home.shop-details', ['id' => $sellingProduct->id]) }}" class="latest-product__item">
                                                    ...
                                                    <div class="latest-product__item__text">
                                                        ...
                                                        <span>${{ formatCurrency($sellingProduct->price) }}</span>
                                                    </div>
                                                </a>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <div class="product__item__price">${{ formatCurrency(calculateDiscountedPrice($saleProduct->price, $saleProduct->discount)) }} <span>${{ formatCurrency($saleProduct->price) }}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
