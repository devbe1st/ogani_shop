...
Route::get('password/confirm', 'App\Http\Controllers\Auth\ConfirmPasswordController@showConfirmForm')->middleware('auth')->name('password.confirm');
Route::post('password/confirm', 'App\Http\Controllers\Auth\ConfirmPasswordController@confirm')->middleware('auth');
/* ---------------------------------- AUTH ---------------------------------- */
...
/* ---------------------------------- SHOP ---------------------------------- */
Route::get('/shop', [ShopController::class, 'shop'])->name('home.shop');
Route::get('/shop/{id}/details', [ShopController::class, 'shopDetails'])->name('home.shop-details');
/* ---------------------------------- SHOP ---------------------------------- */

/* ---------------------------------- BLOG ---------------------------------- */
Route::get('/blog', [BlogController::class, 'blog'])->name('home.blog');
Route::get('/blog/{id}/details', [BlogController::class, 'blogDetails'])->name('home.blog-details');
/* ---------------------------------- BLOG ---------------------------------- */

/* ---------------------------------- USER ---------------------------------- */
Route::get('/user/profile', [ProfileController::class, 'index'])->name('user.profile')->middleware('auth');
Route::get('/user/favourite', [FavouriteController::class, 'index'])->name('user.favourite');
Route::get('/user/cart', [CartController::class, 'index'])->name('user.cart');
Route::get('/user/checkout', [CheckoutController::class, 'index'])->name('user.checkout')->middleware('auth');
/* ---------------------------------- USER ---------------------------------- */

/* ---------------------------------- ADMIN --------------------------------- */
Route::prefix('admin-panel')->middleware(['auth', 'admin'])->name('admin.')->group(function () {
    ...
    Route::put('/category/{id}/update-status', [AdminCategoryController::class, 'updateStatus'])->name('category.update-status');
    ...
    Route::get('/order/{id}/show', [AdminOrderController::class, 'show'])->name('order.show');
});
/* ---------------------------------- ADMIN --------------------------------- */
